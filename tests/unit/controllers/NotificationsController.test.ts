...
describe('NotificationsController', () => {
  ...
  it('should retrieve all notifications by patient using the default sort order', async () => {
    const executeMock = vi.fn().mockResolvedValue([mockNotificationDocument]);

    vi.spyOn(factories, 'getAllNotificationsByPatientUseCase').mockReturnValue({
      execute: executeMock,
    } as any);
  ...
  it('should retrieve all notifications by patient using a specified sort order', async () => {
    const executeMock = vi.fn().mockResolvedValue([mockNotificationDocument]);
